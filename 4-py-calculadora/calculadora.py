...
import ttkbootstrap as ttk # Importa a biblioteca para a interface gráfica
...
def resource_path(relative_path):
    try:
        ...
        # Usa a pasta do próprio arquivo para funcionar sempre em qualquer diretório
...
class Calculadora:
    ...
    def criar_display(self):
        ...
        self.display= ttk.Label(
            ...
            anchor="e", # Alinha o texto à direita - "East"
            padding=(20, 10),
        )
    ...
    def criar_seletor_tema(self):
        ...
        self.label_tema = ttk.Label(self.frame_tema, text="Tema:")
    ...
    def calcular(self):
        ...
        # digitado no display atráves do eval() logo abaixo
