...
# Obtém o caminho absoluto para um recurso funcionando rodando o .py
...
class GeradorSenha:
    ...
    def __init__(self):
        ...
        self.janela.title("Gerador de Senhas Guloso")
    ...
    def carregar_icone(self):
        try:
            ...
            self.icon_photo = ImageTk.PhotoImage(icon_image) # guarda a referencia
    ...
    # Gera uma senha bem louquinha com caracteres ASCII imprimíveis (33 a 126)
