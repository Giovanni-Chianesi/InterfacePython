...
class InterfaceExemplo:
    ...
    def __init__(self):
        self.janela = tk.Tk()
        self.janela.title("Exemplo de Interface Sigma")
        self.janela.geometry("400x150")
        # Cor de fundo da janela
        self.janela.configure(bg="#2d3e50")
        self.criar_widgets()
        
    # Montar todos os elementos visuais da interface
    def criar_widgets(self):
        # Caixa de entrada "Entry" ou input onde o usuário digita o texto algo "Texto"
        ...
        self.label_resultado = tk.Label(self.janela, text="", fg="red", font=("Arial", 18, "bold"))
        self.label_resultado.pack(pady=10)
        
    # Captura o texto digitado pelo usuário (No "Entry" ou "Input") e transfere ele para variável texto 
    # para ser exibido em "label_resultado"
