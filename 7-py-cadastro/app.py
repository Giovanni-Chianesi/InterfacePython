...
# Obtém o caminho absoluto para um recurso (imagem/icone), funcionando tanto
...
# se perdem a cada nova versão gerada ao executável
def get_db_path():
...
# Simples e sem dependências externas - mais seguro do que guardar a senha em texto puro
def gerar_hash_senha(senha):
    return hashlib.sha256(senha.encode("utf-8")).hexdigest()


# Camada de acesso ao banco de dados: usuários cadastrados + credencias de login
class Database:
    ...
    # Cria as tabelas de usuários e credenciais, se ainda não existirem
    ...
    # Cria o usuário admin/admin na primeira execução, se ele ainda não existir
    ...
    # Verifica se usuário e senha batem com o hash salvo no banco
...
# Formata progressivamente um telefone digitado para (XX) XXXXX-XXXX.
...
class TelaLogin(ctk.CTk):
    ...
    # Verifica as credenciais digitadas e, se corretas, abre a tela de cadastro
...
class TelaCadastro(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        self.light_icon = ctk.CTkImage(
            light_image=Image.open(resource_path("light_icon.png")),
            size=(20, 20),
        )
        self.dark_icon = ctk.CTkImage(
            light_image=Image.open(resource_path("dark_icon.png")),
            size=(20, 20),
        )
        ...
        self.cadastrar_icon = ctk.CTkImage(
            light_image=Image.open(resource_path("cadastrar_icon.png")),
            size=(20, 20),
        )
        self.cancelar_icon = ctk.CTkImage(
            light_image=Image.open(resource_path("cancelar_icon.png")),
            size=(20, 20),
        )
        self.listar_icon = ctk.CTkImage(
            light_image=Image.open(resource_path("listar_icon.png")),
            size=(20, 20),
        )
    ...
    def cadastrar(self):
        ...
        if nome and email and telefone:
            ...
            messagebox.showinfo("Sucesso", "Usuário cadastrado com sucessox!")
            self.limpar_campos()
        else:
            messagebox.showerror("Erro", "Por favor, preencha todos os campos agora.")
    ...
    # Abre a janela de listagem, escondendo a tela de cadastro por trás
...
class TelaLista(ctk.CTkToplevel):
    ...
    def setup_ui(self):
        ...
        self.atualizar_icon = ctk.CTkImage(
            light_image=Image.open(resource_path("atualizar_icon.png")),
            size=(20, 20),
        )
        self.excluir_icon = ctk.CTkImage(
            light_image=Image.open(resource_path("excluir_icon.png")),
            size=(20, 20),
        )
        self.voltar_icon = ctk.CTkImage(
            light_image=Image.open(resource_path("voltar_icon.png")),
            size=(20, 20),
        )
